...
class TestLabelingTaskAdmin(BaseTestCase):
  ...
  def test_get_protected_by_status_when_all_are_archived_and_failed(self):
    tasks = [
  ...
  def test_get_protected_by_status_when_all_are_failed(self):
    tasks = [
      LabelingTask(status=LabelingTaskStatus.FAILED),
      LabelingTask(status=LabelingTaskStatus.FAILED),
    ]
  ...
  def test_get_protected_by_status_when_some_tasks_are_not_failed(self):
    tasks = [
